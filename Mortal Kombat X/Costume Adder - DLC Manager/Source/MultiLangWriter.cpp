...
int main()
{
    ...
    while(Efin>>E)
    {
        ...
        case 'T': find2[ctr]=1; ctr++; break;
        case 'r': find2[ctr]=1; ctr++; break;
        case 'e': find2[ctr]=1; ctr++; break;
        case 'm': find2[ctr]=1; ctr++; break;
        case 'o': find2[ctr]=1; ctr++; break;
        case '=': find2[ctr]=1; ctr++; break;
        case 'E': find2[ctr]=1; ctr++; break;
        case 'M': find2[ctr]=1; ctr++; break;
        case 'O': find2[ctr]=1; ctr++; break;
        case 'P': find2[ctr]=1; ctr++; break;
        default : for (int i = 0; i < 20; i++) find2[i]=0; ctr = 0;
        }
        if (find2[19] == 1)
            break;
